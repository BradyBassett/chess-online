...
std::vector<std::pair<std::string, BitboardBinaryOperationsTestParam>> BitboardXORTest::testCases = {
	...
	{"RandomBits_XOR_RandomBits", generateRandomBitwiseTestParam(std::bit_xor<uint64_t>{})},
	...
	{"SingleBitSet_XOR_RandomBits", generateRandomBitwiseTestParam(std::bit_xor<uint64_t>{}, 0x20000000000000, false)},
};
