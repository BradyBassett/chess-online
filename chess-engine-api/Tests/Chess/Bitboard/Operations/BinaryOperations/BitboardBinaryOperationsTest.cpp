#include "BitboardBinaryOperationsTest.hpp"
	...
	BitboardBinaryOperationsTestParam BitboardBinaryOperationsTest::generateRandomTestParam(std::function<uint64_t(uint64_t, uint64_t)> operation, uint64_t value1, bool useRandomValue1) {
